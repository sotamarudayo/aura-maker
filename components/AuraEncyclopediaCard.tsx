...
export default function AuraEncyclopediaCard({
  ...
  return (
    <Link
      href={`/auras/${aura.id}`}
      className="block min-w-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-300"
      aria-label={`${t.encyclopedia.openDetail}: ${isSecret ? t.aura.secretName : aura.archetypeName}`}
    >
      <article
